 ...
 *   3. DSH 凭证缝的 ref TYPESAFE_AI_API_KEY（~/.dsh/.credentials.yaml 的 refs）
 *
 ...
 *
 * 第 3 层只走凭证缝：它按 YAML 语义解析并自带分层覆盖（继承环境 > 项目 .env > 用户 .env >
 * 凭证文件），来源见 `ResolvedCredential.source`。不要改回自己读 `$DSH_HOME/.credentials.yaml`。
 *
